...
public class HDFC extends AbstractLanguageAnalyser {

  private static final Logger log = Logger.getLogger(HDFC.class);
  ...
  /**
   * Execute this creditcard over the current document.
  ...
  public void execute() throws ExecutionException {
    ...
    // long.
    if(isInterrupted()) {
      throw new ExecutionInterruptedException("Execution of creditcard has been interrupted!");
    }
    interrupted = false;
